var copyCode =
{
	...
	copyToClipboard: function(link)
	{
		...
		else
		{
			...
			var divinfo = '<embed src="@blog.baseurl@/themes/@theme.name@/bin/clipboard.swf" FlashVars="clipboard=' + encodeURIComponent(text) + '" width="0" height="0" type="application/x-shockwave-flash"></embed>';
